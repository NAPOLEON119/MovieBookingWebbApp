...
<head>
    ...
    <title>Registration Success - Movie Theme</title>
        ...
        <section id="center" class="centre_o pt-5 pb-5">
            <div class="container-xl">
                <div class="row centre_o1 text-center">
                    <div class="col-md-12">
                        <h1 class="text-white font_60">Registration Successful!</h1>
                        <h5 class="mb-0 mt-3 fw-normal col_oran">Welcome to Movie Theme</h5>
                    </div>
                </div>
            </div>
        </section>
...
<section id="success" class="p_3">
    <div class="container-xl">
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                <div class="success_box bg-dark p-5 rounded">
                    <i class="fa fa-check-circle text-success fa-4x mb-4"></i>
                    <h2 class="text-white mb-4">Thank You for Registering!</h2>
                    <p class="text-white-50 mb-4">Your account has been successfully created. You can now enjoy all our services including movie bookings, special offers, and more!</p>
                    <div class="mt-4">
                        <a href="login.jsp" class="button me-3">Login Now</a>
                        <a href="index.html" class="button_1">Back to Home</a>
                    </div>
                </div>
            </div>
        </div>
